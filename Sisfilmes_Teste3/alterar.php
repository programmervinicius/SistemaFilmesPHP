...
<table align="center">
<tr>
<form name="relatorio" method="post" action="altere.php"enctype="multipart/form-data"  onsubmit= "return valida(); return false;">
<td>Grupo:</td>
...
<tr>
<td>Tipo Filme:</td>
<td><select name="cod_tipo" id="cod_tipo">
...
<td>Gênero:</td>
<td><select name="cod_gen" id="cod_gen">
<option selected value="<?php echo $cod_gen?>"><?php echo $genero?></option>
...
<tr>
<td>Tipo:</td>
<td><select name="cod_trad" id="cod_trad">
<option selected value="<?php echo $cod_trad?>"><?php echo $traducao?></option>
...
<!--<tr><td></td><td><input name="imagem" type="text" id="imagem" size="15" value="<?php echo $imagem?>"><td></tr>-->
<tr><td></td><td><input name="imagem2" type="file" id="imagem2" size="15"><td></tr>
<tr></tr>
<tr></tr>
<tr></tr>
<tr></tr>
<tr></tr>
<td></td>
<td><input name="submit" type="submit" value="Alterar"/>
