...
include('formata.php');
//include('valida2_cpf.php');
?>
                                            

<html>
<head>
<title>inser_cliente.php</title>
...
<br>
<hr width="600">
<center><h1>Inserir Clientes</h1></center>
<table align="center">
<tr>
<form name="relatorio" method="post" action="insere_cliente.php" onsubmit= "return valida(); return false;">
<td>Nome:</td>
<td><input name="nome" type="text" id="nome" size="45" value=""></td>
</tr>
<tr>
<td>Endereço:</td>
<td><input name="endereco" type="text" id="endereco" size="60" value=""></td>
</tr>
<tr>
<td>Bairro:</td>
<td><input name="bairro" type="text" size="45" value=""></td>
<tr>
<td>Uf:</td>
...
<td>Cep:</td>
<td><input name="cep" type="text" id="cep" size="5" maxlength="9" value=""></td>
</tr>
<tr>
<td>Telefone:</td>
<td><input name="telefone" type="text" id="telefone" size="10" maxlength="9" value=""></td>
</tr>
<tr>
<td>Celular:</td>
<td><input name="celular" type="text" id="celular" size="12" maxlength="12" value=""></td>
</tr>
<tr>
<td>Data Nasc:</td>
<td><input name="dat_nasc" type="text" id="dat_nasc" size="7" maxlength="10" class="dat_nasc" value=""></td>
</tr>
<tr>
<td>Rg:</td>
<td><input name="rg" type="text" id="rg" size="12"value=""></td>
</tr>
<tr>
<td>Cpf:</td>
<td><input name="cpf" type="text" id="cpf" size="12" value=""></td>
</tr>
<tr>
<tr>
<td>Email:</td>
<td><input name="email" type="text" id="email" size="60"value=""></td>
</tr>
